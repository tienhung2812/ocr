...
from text_detection.utils.text_connector.other import clip_boxes
from text_detection.utils.text_connector.text_proposal_graph_builder import TextProposalGraphBuilder
